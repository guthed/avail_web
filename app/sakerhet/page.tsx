...
const principles = [
  {
    titel: "Data i Sverige och EU",
    text: "Alla system – databaser, AI-modeller och vektorlager – driftsätts i EU-hostade miljöer. Vi använder enbart leverantörer med EU-datapolicyer (Azure EU North, AWS eu-north-1, Supabase EU).",
  },
  {
    titel: "Ingen träning på kunddata",
    text: "Din data används aldrig för att träna generella AI-modeller. Vi konfigurerar API-anrop explicit med opt-out från träning hos alla AI-leverantörer. Era dokument och konversationer stannar hos er.",
  },
  {
    titel: "Minsta möjliga behörighet",
    text: "Varje systemkomponent har åtkomst enbart till den data den faktiskt behöver. Inga bred läsrättigheter, inga delade hemligheter i kod. Secrets hanteras via Vault eller plattformsspecifika hemlighetstjänster.",
  },
  {
    titel: "Krypterad data i vila och transit",
    text: "All data krypteras med AES-256 i vila. All kommunikation sker över TLS 1.3. Databaser exponeras aldrig direkt – all åtkomst går via autentiserade API-lager.",
  },
];
    ...
    <>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <div>
            {faqs.map((faq) => (
              <SecurityFAQ key={faq.fraga} fraga={faq.fraga} svar={faq.svar} />
            ))}
          </div>
        </div>
      </section>
